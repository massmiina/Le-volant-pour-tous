...
export default function CoursVitesse() {
  const { t } = useLanguage();

  const moduleData = (t('cours.vitesse', { returnObjects: true }) as any);
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-24 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12 space-y-16">
        ...
        <AnimatedSection>
           <ModuleQuiz moduleId={4} questions={quizData.questions} title={quizData.title} intro={quizData.intro} />
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-gray-900 rounded-3xl p-10 md:p-14 text-center shadow-xl mt-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              <Link href="/cours/3" className="w-full sm:w-auto px-10 py-5 bg-gray-800 hover:bg-gray-700 text-white font-black rounded-xl transition-all shadow-lg text-lg flex items-center justify-center gap-2 border border-gray-700">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                {t('ui.prev_module', { number: 3 })}
              </Link>
              <Link href="/cours/5" className="w-full sm:w-auto px-10 py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl transition-all shadow-lg hover:shadow-blue-900/40 text-lg flex items-center justify-center gap-2">
                {t('ui.next_module', { number: 5 })}
