...
export default function CoursSecurite() {
  ...
  const moduleData = (t('cours.securite', { returnObjects: true }) as any);
    ...
    <div className="bg-gray-50 min-h-screen pb-24 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12 space-y-16">
        ...
        {quizData.questions && quizData.questions.length > 0 && (
          <AnimatedSection>
             <ModuleQuiz moduleId={7} questions={quizData.questions} title={quizData.title} intro={quizData.intro} />
          </AnimatedSection>
        )}
