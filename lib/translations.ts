    ...
    quiz: {
      ...
      modules: {
        ...
        alcool: [
          ...
          { q: "Управление машиной после бессонной ночи так же опасно, как вождение с уровнем алкоголя:", o1: "0,5 г/л d'alcool", o2: "0,2 g/l d'alcool", o3: "1,5 g/l d'alcool", o4: "Rien du tout", ans: 0, exp: "Le manque de sommeil a des effets similaires à l'alcool on le temps de réaction." }, // Using the exact French keys for ease of matching or we can use the exact same logic
          // Let's use the exact text from translations:
          // `{ q: "Après une nuit blanche, conduire est aussi dangereux qu'avec :", o1: "0,5 g/l d'alcool", o2: "0,2 g/l d'alcool", o3: "1,5 g/l d'alcool", o4: "Rien du tout", ans: 0, exp: "Le manque de sommeil a des effets similaires à l'alcool on le temps de réaction." },`
          // Let's write the Russian translation precisely:
        ...
        mecanique: [
          ...
          { q: "Уровень motorного масла проверяется:", o1: "При работающем двигателе", o2: "При холодном двигателе на ровной поверхности", o3: "Раз в 10 лет", o4: "Во время движения", ans: 1, exp: "Необходимо, чтобы масло стекло в картер, а автомобиль находился на строго горизонтальной поверхности." }, // Note: "motorного" or "моторного" -> let's make sure it is "моторного"
