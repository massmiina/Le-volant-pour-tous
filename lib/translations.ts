...
export const translations: Record<Language | string, any> = {
  fr: {
    ...
    home: {
      ...
      interactive_desc: "Plongez dans des situations 3D et des quiz immersifs pour valider votre code facilement.",
    ...
    account: {
      ...
      subtitle: "Gérez vos informations de pilote et vos préférences",
      profile_info: "Informations de Profil",
      email: "Adresse Email",
      name: "Nom d'utilisateur / Pseudo",
      ...
      reset_stats_title: "Réinitialiser ma progression",
      reset_stats_desc: "Efface tout l'historique de vos scores et modules lus. Cette action est irréversible.",
      reset_stats_btn: "Réinitialiser",
      delete_account_title: "Supprimer mon compte",
      delete_account_desc: "Supprime définitivement votre compte et toutes vos données associées de notre système.",
      delete_account_btn: "Supprimer mon compte",
      confirm_reset: "Êtes-vous sûr de vouloir réinitialiser toutes vos statistiques ? Cette action est définitive.",
      confirm_delete: "Êtes-vous sûr de vouloir supprimer définitivement votre compte ? Cette action est irréversible et vous déconnectera immédiatement.",
      success_update: "Profil mis à jour avec succès !",
      success_reset: "Statistiques réinitialisées avec succès !",
      error_generic: "Une erreur est survenue.",
    ...
    situations: {
      ...
      list: [
        ...
        },
        {
          ...
          exp: "En tunnel, la distance de sécurité minimale (les diodes bleues de balisage latéral ou au sol) doit être maintenue même à l'arrêt pour éviter la propagation d'incendies. Couper le moteur limite la concentration de gaz toxiques (Code de la route R412-11-1).",
          correctAnswer: 2
        },
        {
  ...
  ru: {
    ...
    home: {
      ...
      welcome_badge: "Добро пожаловать в современный формат",
      ...
      interactive_desc: "Погрузитесь в 3D-ситуации и квизы для легкой подготовки к экзамену.",
    ...
    quiz: {
      ...
      modules: {
        ...
        alcool: [
          ...
          { q: "Является ли наличие алкотестера обязательным в каждом автомобиле во Франции (рекомендуется) :", o1: "Верно", o2: "Неверно", o3: "Только для грузовиков", o4: "Только ночью", ans: 0, exp: "Хотя штраф за отсутствие тестера был отменен, наличие прибора носит обязательный характер (рекомендовано для самоконтроля)." },
    ...
    cours: {
      ...
      signalisation: {
        ...
        footer_desc: "Вы изучили основы дорожных знаков и разметки. Готовы к следующему шагу?",
        btn_test: "Тест по знакам",
        sections: [
          {
            id: "objectif",
            title: "🎯 ЦЕЛЬ",
            desc: "Система дорожных знаков и разметки позволяет организовать общественное пространство.",
            rules: [
          ...
          },
          {
            ...
            desc: "Дорожная разметка имеет то же значение, что и знаки.",
            rules: [
          ...
          },
          {
            ...
            rules: [
              ...
              { title: "Желтый", text: "Требуется остановка, кроме случаев опасности сзади." },
          ...
          },
          {
            ...
            rules: [
              { title: "Порядок приоритета", text: "1. Регулировщик 👮, 2. Светофоры 🚦, 3. Знаки 🚧, 4. Разметка 🛣️." }
            ],
      ...
      alcool: {
        ...
        quiz_section: {
          title: "🧪 Тест: Алкоголь и Наркотики",
    ...
    account: {
      ...
      subtitle: "Управление вашими данными и настройками аккаунта",
      profile_info: "Информация о профиле",
      email: "Email адрес",
      name: "Имя пользователя / Никнейм",
      member_since: "В клубе с",
      change_password: "Сменить пароль",
      current_password: "Текущий пароль",
      new_password: "Новый пароль",
      btn_save: "Сохранить изменения",
      danger_zone: "Опасная зона",
      reset_stats_title: "Сбросить прогресс",
      reset_stats_desc: "Стирает всю историю ваших результатов и прочитанных модулей. Это действие необратимо.",
      reset_stats_btn: "Сбросить",
      delete_account_title: "Удалить аккаунт",
      delete_account_desc: "Безвозвратно удаляет ваш аккаунт и все связанные данные из нашей системы.",
      delete_account_btn: "Удалить аккаунт",
      confirm_reset: "Вы уверены, что хотите сбросить всю свою статистику? Это действие окончательно.",
      confirm_delete: "Вы уверены, что хотите навсегда удалить свой аккаунт? Это действие необратимо, и вы будете немедленно отключены.",
      success_update: "Профиль успешно обновлен!",
      success_reset: "Статистика успешно сброшена!",
      error_generic: "Произошла ошибка.",
      loading: "Обработка..."
    },
    dashboard: {
    ...
    situations: {
      ...
      list: [
        ...
        },
        {
          ...
          exp: "В тоннеле минимальная безопасная дистанция должна соблюдаться даже при остановке (по синим диодам разметки) во избежание распространения огня в случае пожара. Отключение двигателя снижает концентрацию токсичных газов (Статья R412-11-1 ПДД Франции).",
          correctAnswer: 2
        },
        {
          ...
          exp: "В населенном пункте обгон велосипедиста требует минимального бокового интервала в 1 метр (Статья R414-4 ПДД Франции). Кроме того, приближение пешехода, переходящего или выражающего намерение перейти дорогу, обязывает предоставить ему приоритет (Статья R415-11 ПДД Франции).",
          correctAnswer: 1
        },
        {
          ...
          exp: "Активное предвидение (ранний отпуск педали газа) позволяет использовать торможение двигателем (нулевой расход топлива при прекращении подачи топлива/отсечке) и стабилизировать поток автомобилей сзади благодаря аварийной сигнализации (Стандарт REMC, Компетенция 4).",
          correctAnswer: 1
        }
      ]
    }
